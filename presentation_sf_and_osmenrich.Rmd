---
title: "Enriching spatial data in R and release NEW osmenrich package"
author: "SoDaTeam"
date: "18/2/2021"
output: beamer_presentation
---

## Introduction to ODESSEI 
- Consortium of 34 Dutch scientific organizations 
- Open data & research infrastructure for social science & economics

\begin{center}
\vspace{20pt}
\includegraphics[width=0.7\textwidth]{figures/odessei_logo.png}
\end{center}


## Introduction to SoDa team
- ODESSEI Social Data Science team (SoDa)
- Aim is to support social scientists in research projects

- SoDa team members:
    1. Daniel Oberski (head team)
    2. Erik-Jan Van Kesteren (coordinator)
    3. Leonardo Vida (engineer)
    4. Helen Lam (researcher/data steward)
    5. Jonathan de Bruin (engineer/support staff liaison)


## How to contribute
- Contributions are greatly appreciated!
- Go to the Github repository: sodascience/osmenrich

## Simple Features

![Illustration (c) by Allison Horst](simple_features/sf_drawing.jpg)
...
![overview](simple_features/sf_drawing.jpg)
...
![Illustration from Edzer Pebesma](simple_features/sf_attributes.png)
...
![ArcGIS](simple_features/arcgis-desktop-features-analytics.png)
...
```{r}
# download 2017 data
wijk_en_buurt_2017 <- st_read_cbs(2017) # remove "data/"
```
...
![Cheatsheet](simple_features/screenshot_cheatsheet.png)

## Resources and examples

https://dominicroye.github.io/en/2018/accessing-openstreetmap-data-with-r/

![](simple_features/dominicroye.png)
